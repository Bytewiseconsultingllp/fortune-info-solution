    ...
    <footer style={{ backgroundColor: "#FDFAF6", color: "#000000" }}>
      ...
      <div ref={newsletterRef} className="py-12 px-4 md:px-8 lg:px-16">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <h3 className="text-3xl font-bold text-secondary">Stay Connected, Stay Informed.</h3>
          <form onSubmit={handleSubscribe} className="flex gap-4 w-full md:w-auto">
            <input
              type="email"
              placeholder="Email"
              value={email}
      ...
      {/* Main Footer */}
      <div ref={mainFooterRef} className="py-16 px-4 md:px-8 lg:px-16 border-t border-secondary/50">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
          ...
          {/* Extra Links */}
          <div>
            <h4 className="text-xl font-bold text-secondary mb-6">Extra Links</h4>
            <ul className="space-y-3">
              {["About Us", "Our Team", "Services", "Case Studies", "FAQ"].map((link) => (
                <li key={link}>
          ...
          {/* Get In Touch */}
          <div>
            <h4 className="text-xl font-bold text-secondary mb-6">Get In Touch</h4>
            <div className="space-y-4 text-secondary/70">
              <div className="flex items-start gap-2">
                <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
                <div>
                  <p>456 Creative District Ahmad Yani, Medan,</p>
                  <p>North Sumatera</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <p>hola@dominantsite.com</p>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <p>+800-3374-4676</p>
      ...
      {/* Bottom Footer */}
      <div ref={bottomFooterRef} className="py-6 px-4 md:px-8 lg:px-16 border-t border-secondary/50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-secondary/70 text-sm">iTech 2024 © All Rights Reserved DexTheme</p>
        </div>
      </div>
    </footer>
  )
